      ...
      <div className="container relative mx-auto px-4">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-xl border dark:border-neutral-800 border-neutral-200 dark:bg-neutral-900 bg-white">
            <div className="flex items-center justify-between border-b dark:border-neutral-800 border-neutral-200 px-4 py-3">
              ...
              <button
                onClick={copyCode}
                className="flex items-center gap-1 text-sm dark:text-neutral-400 text-neutral-600 hover:text-white transition-colors"
              >
                {copied ? (
                  <>
